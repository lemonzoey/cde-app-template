...
export default {
  ...
  addEvent() {
    ...
    iframe.onload = function() {
      ...
      //获取input按钮
      let inpaddress = document.getElementById('iframe').contentWindow.document.getElementsByTagName("input")[0]
      //获取模态框
      let modal = document.getElementsByClassName('modal')[0]
      let mymodal = modal.children[5]
      ...
      //线上地址
      let fixdaddress = rootPath.join(__dirname, '../../../../newProject')
      //线下地址
      // let fixdaddress = rootPath.join(__dirname, '../../newProject')
      ...
      setSelectionRange(inpaddress, val.length - 10, val.length)
